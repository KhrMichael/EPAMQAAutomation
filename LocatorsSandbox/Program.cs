...
var newsButton = chromeDriver.FindElement(By.XPath("//*[@id='orb-header']//*[@class='orb-nav-newsdotcom']"));
newsButton.Click();
...
var belarusFirstNews = chromeDriver.FindElement(By.XPath("//*[@class='ssrcss-1020bd1-Stack e1y4nx260']/li[1]"));
